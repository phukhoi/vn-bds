jQuery( function ( $ )
{
	...
	function update()
	{
        ...
        if ( typeof options.formatResult != 'undefined' && options.formatResult == 'gallery_post_image' ) {
            options.formatResult = formatResult;
            options.formatSelection = formatResult;
        ...
        function formatResult (state) {
            ...
            return "<img class='flag' src='" + $(originalOption).data('image') + "' alt='' /><span>" + state.text + '</span>';
        };
	}
